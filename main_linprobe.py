...
def get_args_parser():
    ...
    parser.add_argument('--motion_aware_tau', default=-1, type=float,
                        help='temperature of motion aware pooling.')    
...
def main(args):
    ...
    model.head.fc = torch.nn.Sequential(
        torch.nn.BatchNorm1d(model.head.fc.in_features, affine=False, eps=1e-6), 
        model.head.fc
    )
