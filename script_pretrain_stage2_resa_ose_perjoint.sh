...
# Controlled counterpart to ReSA-only + per-joint 3-token mask:
# keep the mask/LR protocol fixed and enable the complete OSE objective.
...
export OUTPUT_DIR="${OUTPUT_DIR:-./output_dir/ntu60_xsub_macdiff_stage2_noaug_syncbn_lr1e3_resaose_perjoint3}"
